...
INSERT IGNORE INTO place_photo (id, place_id, author_nickname, order_index, user_id, CREATE_DATE, UPDATE_DATE) VALUES
  (100, 10, '영진파도', 0, 1, NOW(), NOW()),
  (101, 10, '주문진러버', 1, 2, NOW(), NOW()),
  (102, 10, '바다봄', 2, 3, NOW(), NOW()),
  (103, 10, '도깨비덕후', 3, 4, NOW(), NOW()),
  (104, 10, '강릉여행러', 4, 5, NOW(), NOW()),
  (105, 10, '파도타기', 5, 1, NOW(), NOW()),
  (110, 11, '개화기러버', 0, 2, NOW(), NOW()),
  (111, 11, '논산여행', 1, 3, NOW(), NOW()),
  (112, 11, '선샤인팬', 2, 4, NOW(), NOW()),
  (113, 11, '애신낭자', 3, 1, NOW(), NOW()),
  (114, 11, '유진초이', 4, 5, NOW(), NOW()),
  (115, 11, '연무대', 5, 2, NOW(), NOW()),
  (120, 12, '청하마실', 0, 3, NOW(), NOW()),
  (121, 12, '포항러', 1, 4, NOW(), NOW()),
  (122, 12, '델루나팬', 2, 1, NOW(), NOW()),
  (123, 12, '시장탐방', 3, 2, NOW(), NOW()),
  (124, 12, '만월언니', 4, 5, NOW(), NOW()),
  (125, 12, '저승사자', 5, 3, NOW(), NOW()),
  (130, 13, '이태원덕후', 0, 4, NOW(), NOW()),
  (131, 13, '단밤단골', 1, 1, NOW(), NOW()),
  (132, 13, '박새로이', 2, 2, NOW(), NOW()),
  (133, 13, '조이서', 3, 3, NOW(), NOW()),
  (134, 13, '포차러버', 4, 5, NOW(), NOW()),
  (135, 13, '서울밤', 5, 4, NOW(), NOW()),
  (140, 14, '덕수궁산책', 0, 1, NOW(), NOW()),
  (141, 14, '돌담길', 1, 2, NOW(), NOW()),
  (142, 14, '도깨비팬', 2, 3, NOW(), NOW()),
  (143, 14, '가을단풍', 3, 4, NOW(), NOW()),
  (144, 14, '정동걷기', 4, 5, NOW(), NOW()),
  (145, 14, '공유님', 5, 1, NOW(), NOW()),
  (150, 15, '호미곶', 0, 2, NOW(), NOW()),
  (151, 15, '바다호텔', 1, 3, NOW(), NOW()),
  (152, 15, '만월씨', 2, 4, NOW(), NOW()),
  (153, 15, '델루나외경', 3, 1, NOW(), NOW()),
  (154, 15, '새벽안개', 4, 5, NOW(), NOW()),
  (155, 15, '평행세계', 5, 2, NOW(), NOW()),
  (160, 16, '녹사평', 0, 3, NOW(), NOW()),
  (161, 16, '이태원걷기', 1, 4, NOW(), NOW()),
  (162, 16, '용산구', 2, 1, NOW(), NOW()),
  (163, 16, '밤거리', 3, 2, NOW(), NOW()),
  (164, 16, '단밤식구', 4, 5, NOW(), NOW()),
  (165, 16, '엔딩씬', 5, 3, NOW(), NOW()),
  (170, 17, '합천여행', 0, 4, NOW(), NOW()),
  (171, 17, '테마파크', 1, 1, NOW(), NOW()),
  (172, 17, '개화기거리', 2, 2, NOW(), NOW()),
  (173, 17, '용주면', 3, 3, NOW(), NOW()),
  (174, 17, '영상촬영', 4, 5, NOW(), NOW()),
  (175, 17, '경남합천', 5, 4, NOW(), NOW());

-- 인증샷 첨부 이미지 (#45a 1:N 분리). 시드 단계에서는 post 1건당 image 1장(imageOrderIndex=0).
INSERT IGNORE INTO place_photo_image (id, place_photo_id, image_url, image_order_index, created_at) VALUES
  (100, 100, 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (101, 101, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (102, 102, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (103, 103, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (104, 104, 'https://images.unsplash.com/photo-1502514276747-de8d3fc3a2cb?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (105, 105, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (110, 110, 'https://images.unsplash.com/photo-1546874177-9e664107314e?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (111, 111, 'https://images.unsplash.com/photo-1518544801976-3e188ea7cce5?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (112, 112, 'https://images.unsplash.com/photo-1528702748617-c64d49f918af?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (113, 113, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (114, 114, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (115, 115, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (120, 120, 'https://images.unsplash.com/photo-1528825871115-3581a5387919?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (121, 121, 'https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (122, 122, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (123, 123, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (124, 124, 'https://images.unsplash.com/photo-1502514276747-de8d3fc3a2cb?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (125, 125, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (130, 130, 'https://images.unsplash.com/photo-1554797589-7241bb691973?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (131, 131, 'https://images.unsplash.com/photo-1528702748617-c64d49f918af?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (132, 132, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (133, 133, 'https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (134, 134, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (135, 135, 'https://images.unsplash.com/photo-1518544801976-3e188ea7cce5?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (140, 140, 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (141, 141, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (142, 142, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (143, 143, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (144, 144, 'https://images.unsplash.com/photo-1502514276747-de8d3fc3a2cb?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (145, 145, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (150, 150, 'https://images.unsplash.com/photo-1528825871115-3581a5387919?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (151, 151, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (152, 152, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (153, 153, 'https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (154, 154, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (155, 155, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (160, 160, 'https://images.unsplash.com/photo-1554797589-7241bb691973?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (161, 161, 'https://images.unsplash.com/photo-1528702748617-c64d49f918af?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (162, 162, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (163, 163, 'https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (164, 164, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (165, 165, 'https://images.unsplash.com/photo-1518544801976-3e188ea7cce5?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (170, 170, 'https://images.unsplash.com/photo-1546874177-9e664107314e?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (171, 171, 'https://images.unsplash.com/photo-1518544801976-3e188ea7cce5?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (172, 172, 'https://images.unsplash.com/photo-1528702748617-c64d49f918af?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (173, 173, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (174, 174, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', 0, NOW()),
  (175, 175, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', 0, NOW());
