...
INSERT IGNORE INTO place_photo (id, place_id, image_url, author_nickname, order_index, user_id, group_key, CREATE_DATE, UPDATE_DATE) VALUES
  (100, 10, 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80', '영진파도', 0, 1, 'gk-seed-100', NOW(), NOW()),
  (101, 10, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', '주문진러버', 1, 2, 'gk-seed-101', NOW(), NOW()),
  (102, 10, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', '바다봄', 2, 3, 'gk-seed-102', NOW(), NOW()),
  (103, 10, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', '도깨비덕후', 3, 4, 'gk-seed-103', NOW(), NOW()),
  (104, 10, 'https://images.unsplash.com/photo-1502514276747-de8d3fc3a2cb?auto=format&fit=crop&w=600&q=80', '강릉여행러', 4, 5, 'gk-seed-104', NOW(), NOW()),
  (105, 10, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', '파도타기', 5, 1, 'gk-seed-105', NOW(), NOW()),
  (110, 11, 'https://images.unsplash.com/photo-1546874177-9e664107314e?auto=format&fit=crop&w=600&q=80', '개화기러버', 0, 2, 'gk-seed-110', NOW(), NOW()),
  (111, 11, 'https://images.unsplash.com/photo-1518544801976-3e188ea7cce5?auto=format&fit=crop&w=600&q=80', '논산여행', 1, 3, 'gk-seed-111', NOW(), NOW()),
  (112, 11, 'https://images.unsplash.com/photo-1528702748617-c64d49f918af?auto=format&fit=crop&w=600&q=80', '선샤인팬', 2, 4, 'gk-seed-112', NOW(), NOW()),
  (113, 11, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', '애신낭자', 3, 1, 'gk-seed-113', NOW(), NOW()),
  (114, 11, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', '유진초이', 4, 5, 'gk-seed-114', NOW(), NOW()),
  (115, 11, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', '연무대', 5, 2, 'gk-seed-115', NOW(), NOW()),
  (120, 12, 'https://images.unsplash.com/photo-1528825871115-3581a5387919?auto=format&fit=crop&w=600&q=80', '청하마실', 0, 3, 'gk-seed-120', NOW(), NOW()),
  (121, 12, 'https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=600&q=80', '포항러', 1, 4, 'gk-seed-121', NOW(), NOW()),
  (122, 12, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', '델루나팬', 2, 1, 'gk-seed-122', NOW(), NOW()),
  (123, 12, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', '시장탐방', 3, 2, 'gk-seed-123', NOW(), NOW()),
  (124, 12, 'https://images.unsplash.com/photo-1502514276747-de8d3fc3a2cb?auto=format&fit=crop&w=600&q=80', '만월언니', 4, 5, 'gk-seed-124', NOW(), NOW()),
  (125, 12, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', '저승사자', 5, 3, 'gk-seed-125', NOW(), NOW()),
  (130, 13, 'https://images.unsplash.com/photo-1554797589-7241bb691973?auto=format&fit=crop&w=600&q=80', '이태원덕후', 0, 4, 'gk-seed-130', NOW(), NOW()),
  (131, 13, 'https://images.unsplash.com/photo-1528702748617-c64d49f918af?auto=format&fit=crop&w=600&q=80', '단밤단골', 1, 1, 'gk-seed-131', NOW(), NOW()),
  (132, 13, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', '박새로이', 2, 2, 'gk-seed-132', NOW(), NOW()),
  (133, 13, 'https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=600&q=80', '조이서', 3, 3, 'gk-seed-133', NOW(), NOW()),
  (134, 13, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', '포차러버', 4, 5, 'gk-seed-134', NOW(), NOW()),
  (135, 13, 'https://images.unsplash.com/photo-1518544801976-3e188ea7cce5?auto=format&fit=crop&w=600&q=80', '서울밤', 5, 4, 'gk-seed-135', NOW(), NOW()),
  (140, 14, 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=600&q=80', '덕수궁산책', 0, 1, 'gk-seed-140', NOW(), NOW()),
  (141, 14, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', '돌담길', 1, 2, 'gk-seed-141', NOW(), NOW()),
  (142, 14, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', '도깨비팬', 2, 3, 'gk-seed-142', NOW(), NOW()),
  (143, 14, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', '가을단풍', 3, 4, 'gk-seed-143', NOW(), NOW()),
  (144, 14, 'https://images.unsplash.com/photo-1502514276747-de8d3fc3a2cb?auto=format&fit=crop&w=600&q=80', '정동걷기', 4, 5, 'gk-seed-144', NOW(), NOW()),
  (145, 14, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', '공유님', 5, 1, 'gk-seed-145', NOW(), NOW()),
  (150, 15, 'https://images.unsplash.com/photo-1528825871115-3581a5387919?auto=format&fit=crop&w=600&q=80', '호미곶', 0, 2, 'gk-seed-150', NOW(), NOW()),
  (151, 15, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', '바다호텔', 1, 3, 'gk-seed-151', NOW(), NOW()),
  (152, 15, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', '만월씨', 2, 4, 'gk-seed-152', NOW(), NOW()),
  (153, 15, 'https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=600&q=80', '델루나외경', 3, 1, 'gk-seed-153', NOW(), NOW()),
  (154, 15, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', '새벽안개', 4, 5, 'gk-seed-154', NOW(), NOW()),
  (155, 15, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', '평행세계', 5, 2, 'gk-seed-155', NOW(), NOW()),
  (160, 16, 'https://images.unsplash.com/photo-1554797589-7241bb691973?auto=format&fit=crop&w=600&q=80', '녹사평', 0, 3, 'gk-seed-160', NOW(), NOW()),
  (161, 16, 'https://images.unsplash.com/photo-1528702748617-c64d49f918af?auto=format&fit=crop&w=600&q=80', '이태원걷기', 1, 4, 'gk-seed-161', NOW(), NOW()),
  (162, 16, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', '용산구', 2, 1, 'gk-seed-162', NOW(), NOW()),
  (163, 16, 'https://images.unsplash.com/photo-1504593811423-6dd665756598?auto=format&fit=crop&w=600&q=80', '밤거리', 3, 2, 'gk-seed-163', NOW(), NOW()),
  (164, 16, 'https://images.unsplash.com/photo-1496483648148-47c686dc86a8?auto=format&fit=crop&w=600&q=80', '단밤식구', 4, 5, 'gk-seed-164', NOW(), NOW()),
  (165, 16, 'https://images.unsplash.com/photo-1518544801976-3e188ea7cce5?auto=format&fit=crop&w=600&q=80', '엔딩씬', 5, 3, 'gk-seed-165', NOW(), NOW()),
  (170, 17, 'https://images.unsplash.com/photo-1546874177-9e664107314e?auto=format&fit=crop&w=600&q=80', '합천여행', 0, 4, 'gk-seed-170', NOW(), NOW()),
  (171, 17, 'https://images.unsplash.com/photo-1518544801976-3e188ea7cce5?auto=format&fit=crop&w=600&q=80', '테마파크', 1, 1, 'gk-seed-171', NOW(), NOW()),
  (172, 17, 'https://images.unsplash.com/photo-1528702748617-c64d49f918af?auto=format&fit=crop&w=600&q=80', '개화기거리', 2, 2, 'gk-seed-172', NOW(), NOW()),
  (173, 17, 'https://images.unsplash.com/photo-1493558103817-58b2924bce98?auto=format&fit=crop&w=600&q=80', '용주면', 3, 3, 'gk-seed-173', NOW(), NOW()),
  (174, 17, 'https://images.unsplash.com/photo-1502741338009-cac2772e18bc?auto=format&fit=crop&w=600&q=80', '영상촬영', 4, 5, 'gk-seed-174', NOW(), NOW()),
  (175, 17, 'https://images.unsplash.com/photo-1505228395891-9a51e7e86bf6?auto=format&fit=crop&w=600&q=80', '경남합천', 5, 4, 'gk-seed-175', NOW(), NOW());
